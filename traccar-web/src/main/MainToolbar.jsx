...
const useStyles = makeStyles()((theme) => ({
  toolbar: {
    ...
    gap: theme.spacing(1),
    minHeight: 64,
    background: 'linear-gradient(135deg, #10263d, #0b2034)',
    color: '#eaf3f7',
    borderBottom: '1px solid rgba(53, 208, 162, .2)',
    '& .MuiIconButton-root': {
      color: '#eaf3f7',
    },
    '& .MuiOutlinedInput-root': {
      ...
      borderRadius: 10,
      '& fieldset': {
        borderColor: 'rgba(143, 211, 255, .2)',
      },
      '&:hover fieldset': {
        borderColor: 'rgba(53, 208, 162, .45)',
      },
...
const MainToolbar = ({
  ...
  return (
    <Toolbar ref={toolbarRef} className={classes.toolbar}>
      <Typography className={classes.title}>Trackers</Typography>
