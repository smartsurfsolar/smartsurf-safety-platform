...
import SmartSurfDashboardPage from './smartsurf/SmartSurfDashboardPage';
import RiderProfilePage from './smartsurf/RiderProfilePage';
import GearPage from './smartsurf/GearPage';
import SafetyPage from './smartsurf/SafetyPage';
import ConditionsPage from './smartsurf/ConditionsPage';
import SessionsPage from './smartsurf/SessionsPage';
import DeviceMappingPage from './smartsurf/DeviceMappingPage';
import IncidentsPage from './smartsurf/IncidentsPage';
import LocalSafetyMapPage from './smartsurf/LocalSafetyMapPage';
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<App />}>
        <Route index element={<SmartSurfDashboardPage />} />
        <Route path="map" element={<MainPage />} />

        <Route path="smartsurf">
          <Route path="sessions" element={<SessionsPage />} />
          <Route path="conditions" element={<ConditionsPage />} />
          <Route path="rider-profile" element={<RiderProfilePage />} />
          <Route path="gear" element={<GearPage />} />
          <Route path="devices" element={<DeviceMappingPage />} />
          <Route path="safety" element={<SafetyPage />} />
          <Route path="incidents" element={<IncidentsPage />} />
          <Route path="local-safety-map" element={<LocalSafetyMapPage />} />
        </Route>
